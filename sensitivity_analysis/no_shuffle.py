...
def run_no_shuffle_analysis(data_dir: str = 'data', output_dir: str = 'sensitivity_analysis/results'):
    """
...
if __name__ == '__main__':
    ...
    run_no_shuffle_analysis(data_dir=args.data_dir, output_dir=args.output_dir)
